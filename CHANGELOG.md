...
- Test Containers: реализовано повторное поднятие контейнеров при перезапуске упавших тестов
...
- Hibernate: добавлен вывод схемы в лог и файлы allure
- Hibernate: убраны зависимости между одновременно создаваемыми запросами в рамках одной сессии
...
- Test Containers: правка сборки контейнеров из нескольких репозиториев сервисов

### 1.4.9

- Test Containers: добавлена возможность работы с несколькими репозиториями сервисов
- Kafka: реализован пул соединений

### 1.4.8

- Core: доработан механизм работы с конфигурациями
- Core: убрана необходимость добавлять org.apache.logging.log4j в тестовые проекты
- Core: реализован fail тестов при возникновении ошибки в BeforeAll
- Test Containers: добавлены методы для создания IBM MQ контейнера
- IBM MQ: доработан метод обработки Message

### 1.4.7

- Selenide: правки расширения для запуска не UI тестов

### 1.4.6

- Core: убрана кастомная аннотация DisplayName
- Selenide: убраны лишние зависимости allure
- Selenide: добавлены аргументы по умолчанию для браузеров
- Test Containers: добавлена возможность выполнения sql скриптов при запуске контейнера c БД
- Test Containers: добавлены методы для работы с различными бд
...
- Core: обновлена интеграция с актуальной TestIT
