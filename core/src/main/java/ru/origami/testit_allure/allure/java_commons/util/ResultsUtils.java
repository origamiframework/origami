...
import ru.origami.testit_allure.allure.java_commons.*;
...
import static ru.origami.testit_allure.allure.java_commons.util.PropertiesUtils.loadAllureProperties;
...
public final class ResultsUtils {
    ...
    public static Link createLink(final ru.origami.testit_allure.annotations.Link link) {
        return createLink(link.value(), link.name(), link.url(), link.allureType());
    }
