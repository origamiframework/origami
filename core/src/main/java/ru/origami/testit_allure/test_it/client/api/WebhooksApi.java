package ru.origami.testit_allure.test_it.client.api;

import jakarta.ws.rs.core.GenericType;
import ru.origami.testit_allure.test_it.client.invoker.*;
import ru.origami.testit_allure.test_it.client.model.SearchWebhooksQueryModel;
import ru.origami.testit_allure.test_it.client.model.WebHookEventType;
import ru.origami.testit_allure.test_it.client.model.WebHookModel;
import ru.origami.testit_allure.test_it.client.model.WebHookPostModel;
...
public class WebhooksApi {
  ...
  public ApiResponse<List<WebHookModel>> apiV2WebhooksGetWithHttpInfo(UUID projectId) throws ApiException {
    ...
    return apiClient.invokeAPI("WebhooksApi.apiV2WebhooksGet", localVarPath, "GET", localVarQueryParams, localVarPostBody,
  ...
  public ApiResponse<Void> apiV2WebhooksIdDeleteWithHttpInfo(UUID id) throws ApiException {
    ...
    return apiClient.invokeAPI("WebhooksApi.apiV2WebhooksIdDelete", localVarPath, "DELETE", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
  ...
  public ApiResponse<WebHookModel> apiV2WebhooksIdGetWithHttpInfo(UUID id) throws ApiException {
    ...
    return apiClient.invokeAPI("WebhooksApi.apiV2WebhooksIdGet", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  /**
   ...
   */
  public void apiV2WebhooksIdPut(UUID id, WebHookPostModel webHookPostModel) throws ApiException {
   ...
   */
  public ApiResponse<Void> apiV2WebhooksIdPutWithHttpInfo(UUID id, WebHookPostModel webHookPostModel) throws ApiException {
    ...
    return apiClient.invokeAPI("WebhooksApi.apiV2WebhooksIdPut", localVarPath, "PUT", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, null, false);
  }
  /**
  ...
  public ApiResponse<WebHookModel> apiV2WebhooksPostWithHttpInfo(WebHookPostModel webHookPostModel) throws ApiException {
    ...
    return apiClient.invokeAPI("WebhooksApi.apiV2WebhooksPost", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  /**
  ...
  public ApiResponse<List<WebHookModel>> apiV2WebhooksSearchPostWithHttpInfo(Integer skip, Integer take, String orderBy, String searchField, String searchValue, SearchWebhooksQueryModel searchWebhooksQueryModel) throws ApiException {
    ...
    return apiClient.invokeAPI("WebhooksApi.apiV2WebhooksSearchPost", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  /**
  ...
  public List<String> apiV2WebhooksSpecialVariablesGet(WebHookEventType eventType) throws ApiException {
    return apiV2WebhooksSpecialVariablesGetWithHttpInfo(eventType).getData();
  }
  ...
  public ApiResponse<List<String>> apiV2WebhooksSpecialVariablesGetWithHttpInfo(WebHookEventType eventType) throws ApiException {
    ...
    return apiClient.invokeAPI("WebhooksApi.apiV2WebhooksSpecialVariablesGet", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
}
