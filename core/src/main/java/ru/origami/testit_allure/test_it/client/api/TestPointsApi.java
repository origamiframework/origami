...
import ru.origami.testit_allure.test_it.client.model.TestPointFilterModel;
import ru.origami.testit_allure.test_it.client.model.TestPointShortGetModel;
import ru.origami.testit_allure.test_it.client.model.TestRunModel;
import ru.origami.testit_allure.test_it.client.model.WorkItemModel;
...
public class TestPointsApi {
  ...
  public ApiResponse<List<TestRunModel>> apiV2TestPointsIdTestRunsGetWithHttpInfo(UUID id) throws ApiException {
    ...
    return apiClient.invokeAPI("TestPointsApi.apiV2TestPointsIdTestRunsGet", localVarPath, "GET", localVarQueryParams, localVarPostBody,
