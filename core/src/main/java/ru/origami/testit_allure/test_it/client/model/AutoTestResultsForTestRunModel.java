...
public class AutoTestResultsForTestRunModel {
  ...
  private JsonNullable<List<String>> failureReasonNames = JsonNullable.<List<String>>undefined();
  ...
  **/
  ...
  public AutoTestResultsForTestRunModel failureReasonNames(List<String> failureReasonNames) {
    this.failureReasonNames = JsonNullable.<List<String>>of(failureReasonNames);
    return this;
  }
  ...
  public AutoTestResultsForTestRunModel addFailureReasonNamesItem(String failureReasonNamesItem) {
    if (this.failureReasonNames == null || !this.failureReasonNames.isPresent()) {
      this.failureReasonNames = JsonNullable.<List<String>>of(new ArrayList<>());
    }
    try {
  ...
  **/
  ...
  public JsonNullable<List<String>> getFailureReasonNames_JsonNullable() {
    return failureReasonNames;
  }
  
  @JsonProperty(JSON_PROPERTY_FAILURE_REASON_NAMES)
  public void setFailureReasonNames_JsonNullable(JsonNullable<List<String>> failureReasonNames) {
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Specifies the result of the autotest execution.")
