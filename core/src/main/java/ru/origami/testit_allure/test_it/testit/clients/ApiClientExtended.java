...
import ru.origami.testit_allure.test_it.client.invoker.ApiResponse;
...
public class ApiClientExtended extends ru.origami.testit_allure.test_it.client.invoker.ApiClient {
    protected Random random = new Random();
    protected String multipartBoundary = "";

    public ApiClientExtended() throws NoSuchAlgorithmException, KeyManagementException {
        super();
    }
