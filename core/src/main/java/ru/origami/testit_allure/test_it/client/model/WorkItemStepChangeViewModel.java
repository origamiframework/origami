...
public class WorkItemStepChangeViewModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(action), hashCodeNullable(expected), hashCodeNullable(comments), hashCodeNullable(testData), index, hashCodeNullable(workItemId), workItem);
  }
