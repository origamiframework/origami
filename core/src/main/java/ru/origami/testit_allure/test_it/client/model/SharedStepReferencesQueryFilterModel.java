...
public class SharedStepReferencesQueryFilterModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(name), hashCodeNullable(globalIds), hashCodeNullable(sectionIds), hashCodeNullable(createdByIds), hashCodeNullable(modifiedByIds), hashCodeNullable(states), hashCodeNullable(priorities), hashCodeNullable(entityTypes), createdDate, modifiedDate, hashCodeNullable(isAutomated), hashCodeNullable(tags));
  }
