...
public class StepModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(workItem, id, hashCodeNullable(action), hashCodeNullable(expected), hashCodeNullable(testData), hashCodeNullable(comments), hashCodeNullable(workItemId));
  }
