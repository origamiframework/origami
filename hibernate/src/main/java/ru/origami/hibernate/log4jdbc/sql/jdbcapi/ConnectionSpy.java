...
public class ConnectionSpy implements Connection, Spy {
    ...
    public ConnectionSpy(Connection realConnection, SpyLogDelegator logDelegator) {
        this(realConnection, ru.origami.hibernate.log4jdbc.sql.jdbcapi.DriverSpy.defaultRdbmsSpecifics, logDelegator);
    }
     ...
     * 						(<code>StatementSpy</code>s, ...)
     */
    public ConnectionSpy(Connection realConnection, RdbmsSpecifics rdbmsSpecifics, SpyLogDelegator logDelegator) {
     ...
     * 						(<code>StatementSpy</code>s, ...)
     */
    public ConnectionSpy(Connection realConnection, RdbmsSpecifics rdbmsSpecifics, long execTime, SpyLogDelegator logDelegator) {
    ...
    public CallableStatement prepareCall(String sql) throws SQLException {
        ...
        try {
            ...
            return reportReturn(methodCall, new ru.origami.hibernate.log4jdbc.sql.jdbcapi.CallableStatementSpy(sql, this, statement, this.log));
        } catch (SQLException s) {
            reportException(methodCall, s, sql);
            throw s;
        }
