 ...
 */
public class ExceptionOccuredMessage extends ru.origami.hibernate.log4jdbc.log.log4j2.message.SqlMessage implements Message {
    ...
    protected void buildMessage() {
    	...
    	if (this.sql == null) {
    		...
    		if (this.isDebugEnabled()) {
    			tempMessage = ru.origami.hibernate.log4jdbc.log.log4j2.message.SqlMessage.getDebugInfo() + SqlMessage.nl + spyNo + ". " + tempSql;
    		} else {
