 ...
 */
public class MethodReturnedMessage extends ru.origami.hibernate.log4jdbc.log.log4j2.message.SqlMessage implements Message {
	...
	protected void buildMessage() {
		...
		if (this.isDebugEnabled()) {
			this.setMessage(ru.origami.hibernate.log4jdbc.log.log4j2.message.SqlMessage.getDebugInfo() + SqlMessage.nl + header);
		} else {
