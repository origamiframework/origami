 ...
 */
public class SqlTimingOccurredMessage extends ru.origami.hibernate.log4jdbc.log.log4j2.message.SqlMessage implements Message {
	...
	protected void buildMessage() {
	    ...
	    if (this.isDebugEnabled()) {
	      out.append(ru.origami.hibernate.log4jdbc.log.log4j2.message.SqlMessage.getDebugInfo());
