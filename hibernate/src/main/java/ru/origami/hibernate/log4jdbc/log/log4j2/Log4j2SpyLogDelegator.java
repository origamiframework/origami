package ru.origami.hibernate.log4jdbc.log.log4j2;

import ru.origami.hibernate.log4jdbc.Properties;
import ru.origami.hibernate.log4jdbc.log.AbstractSpyLogDelegator;
import ru.origami.hibernate.log4jdbc.log.log4j2.message.ConnectionMessage;
import ru.origami.hibernate.log4jdbc.log.log4j2.message.ConnectionMessage.Operation;
import ru.origami.hibernate.log4jdbc.log.log4j2.message.ExceptionOccuredMessage;
import ru.origami.hibernate.log4jdbc.log.log4j2.message.MethodReturnedMessage;
import ru.origami.hibernate.log4jdbc.log.log4j2.message.SqlTimingOccurredMessage;
import ru.origami.hibernate.log4jdbc.sql.Spy;
import ru.origami.hibernate.log4jdbc.sql.jdbcapi.ResultSetSpy;
import ru.origami.hibernate.log4jdbc.sql.resultsetcollector.ResultSetCollector;
import ru.origami.hibernate.log4jdbc.sql.resultsetcollector.ResultSetCollectorPrinter;
...
public class Log4j2SpyLogDelegator extends AbstractSpyLogDelegator {
     ...
     * @see ru.origami.hibernate.log4jdbc.Log4j2SpyLogDelegator#debugLogger
     */
     ...
     * @see ru.origami.hibernate.log4jdbc.sql.resultsetcollector
     */
    ...
    public void methodReturned(Spy spy, String methodCall, String returnMsg) {
        ...
        Marker marker = ResultSetSpy.classTypeDescription.equals(classType) ? RESULTSET_MARKER : AUDIT_MARKER;

        LOGGER.info(marker, new MethodReturnedMessage(spy, methodCall, returnMsg, LOGGER.isDebugEnabled(marker)));
    }	
    ...
    private void connectionModified(Spy spy, long execTime, Operation operation) {
        LOGGER.info(CONNECTION_MARKER, new ConnectionMessage(spy, execTime, operation, LOGGER.isDebugEnabled(CONNECTION_MARKER)));
    }
