...
import ru.origami.hibernate.log4jdbc.log.SpyLogFactory;
 ...
 *   </bean>
 *
 *   <bean id="dataSource" class="ru.origami.hibernate.log4jdbc.Log4jdbcProxyDataSource">
 ...
 * </bean>
 *
 * <bean id="slf4jDelegator" class="ru.origami.hibernate.log4jdbc.log.slf4j.Slf4jSpyLogDelegator"/>
 *
 * <bean id="rdbmsSpecifics" class="ru.origami.hibernate.log4jdbc.sql.rdbmsspecifics.OracleRdbmsSpecifics"/>
 *
 * <bean id="dataSource" class="ru.origami.hibernate.log4jdbc.Log4jdbcProxyDataSource">
 * <constructor-arg ref="dataSourceSpied" />
