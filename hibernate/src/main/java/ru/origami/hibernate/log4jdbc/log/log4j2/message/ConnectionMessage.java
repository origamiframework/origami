package ru.origami.hibernate.log4jdbc.log.log4j2.message;
 ...
 */
public class ConnectionMessage extends ru.origami.hibernate.log4jdbc.log.log4j2.message.SqlMessage implements Message {
  ...
  protected void buildMessage() {
    ...
    if (this.isDebugEnabled()) {
      buildMsg.append(ru.origami.hibernate.log4jdbc.log.log4j2.message.SqlMessage.getDebugInfo());
      buildMsg.append(ru.origami.hibernate.log4jdbc.log.log4j2.message.SqlMessage.nl);
    }
