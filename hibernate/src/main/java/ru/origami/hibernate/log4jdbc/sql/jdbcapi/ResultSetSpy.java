...
import ru.origami.hibernate.log4jdbc.sql.jdbcapi.StatementSpy;
import ru.origami.hibernate.log4jdbc.sql.resultsetcollector.DefaultResultSetCollector;
...
public class ResultSetSpy implements ResultSet, Spy
{
  ...
  {
    String methodCall = "updateObject(" + columnIndex + ", " + x + ", " + targetSqlType+ ", " + scaleOrLength + ")";
    try
    {
  ...
  {
    String methodCall = "updateObject(" + columnLabel + ", " + x + ", " + targetSqlType+ ", " + scaleOrLength + ")";
    try
    {
  ...
  {
    String methodCall = "updateObject(" + columnIndex + ", " + x + ", " + targetSqlType + ")";
    try
    {
  ...
  {
    String methodCall = "updateObject(" + columnLabel + ", " + x + ", " + targetSqlType + ")";
    try
    {
